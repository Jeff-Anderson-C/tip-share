...
class Pool(models.Model):
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    total_tips = models.DecimalField(max_digits=10, decimal_places=0, null=True)
    total_hours = models.DecimalField(max_digits=10, decimal_places=0, null=True)
    # --related fields--
...
class Transaction(models.Model):
    tips_shared = models.DecimalField(max_digits=10, decimal_places=0, null=True)
    hours_worked = models.DecimalField(max_digits=10, decimal_places=0, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    # --related fields--
    ...
    recipients = models.ForeignKey(User, related_name="transactions_recieved", on_delete=CASCADE, null=True)
